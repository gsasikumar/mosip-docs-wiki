...
#### Status: Draft 
#### Last updated date: 2nd March 2020
...
The FTM should protect against the following threats.
	...
	2. Hardware Tamper attacks
      ...
      b. Voltage & frequency related attacks - Should sheild against voltage leaks and should prevent against low voltage. The FTM should always be in either of the state operational normally or inoperable. The FTM should never be operatable when its input voltages are not met.
      c. Temperature attacks on crypto block - Low or High the FTM is expected to operate or reach inoperable state. No state inbetween.
